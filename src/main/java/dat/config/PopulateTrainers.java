...
public class PopulateTrainers {
    ...
    private static List<Trainer> getHoennTrainers(EntityManager em) {
        ...
        trainers.add(new Trainer("Wattson", "Hoenn", "Mauville City", "https://archives.bulbagarden.net/media/upload/d/d6/Mauville_City_RS.png", "https://archives.bulbagarden.net/media/upload/b/b2/Spr_RS_Wattson.png", "https://archives.bulbagarden.net/media/upload/3/34/Dynamo_Badge.png", "Electric", 29, false, true, false, getPokemonForTrainer(em, 81, 100, 82)));
        ...
        trainers.add(new Trainer("Winona", "Hoenn", "Fortree City", "https://archives.bulbagarden.net/media/upload/7/7c/Fortree_City_RS.png", "https://archives.bulbagarden.net/media/upload/0/0e/Spr_RS_Winona.png", "https://archives.bulbagarden.net/media/upload/6/62/Feather_Badge.png", "Flying", 32, false, true, false, getPokemonForTrainer(em, 277, 279, 227, 334)));
        trainers.add(new Trainer("Tate and Liza", "Hoenn", "Mossdeep City", "https://archives.bulbagarden.net/media/upload/3/38/Mossdeep_City_RS.png", "https://archives.bulbagarden.net/media/upload/3/38/Spr_RS_Tate_and_Liza.png", "https://archives.bulbagarden.net/media/upload/c/cc/Mind_Badge.png", "Psychic", 33, false, true, false, getPokemonForTrainer(em, 338, 337)));
        trainers.add(new Trainer("Wallace", "Hoenn", "Sootopolis City", "https://archives.bulbagarden.net/media/upload/c/cf/Sootopolis_City_RS.png", "https://archives.bulbagarden.net/media/upload/b/b1/Spr_RS_Wallace.png", "https://archives.bulbagarden.net/media/upload/9/9b/Rain_Badge.png", "Water", 34, false, true, false, getPokemonForTrainer(em, 370, 340, 364, 119, 350)));
        ...
        trainers.add(new Trainer("Steven", "Hoenn", "Mossdeep City", "https://archives.bulbagarden.net/media/upload/3/38/Mossdeep_City_RS.png", "https://archives.bulbagarden.net/media/upload/a/ad/Spr_RS_Steven.png", null, "Steel", 39, false, false, true, getPokemonForTrainer(em, 227, 344, 306, 346, 348, 376)));
